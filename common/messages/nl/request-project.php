...
return [
    ...
    'The following is an overview of the project that will be generated, along with the estimated price of the project.' => 'Deze stap toont de geselecteerde opties en een overzicht van de eenmalige en maandelijkse kosten op basis van uw gekozen opties. Klik op de knop \'Bevestigen\' om de aanvraag definief te maken. Vervolgens dient u uw gegevens in te vullen en wordt de aanvraag opgeslagen. Er wordt dan contact met u opgenomen voor het bespreken van de offerte.',
    'Total' => 'Totaal',
